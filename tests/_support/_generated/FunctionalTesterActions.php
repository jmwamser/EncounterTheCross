...
// [STAMP] e79fbae1c376af6e7343c19772c4bcb4
// phpcs:ignoreFile
...
trait FunctionalTesterActions
{
     ...
     *
     * @see \Codeception\Module\Foundry::have()
     */
     ...
     * @return object[]
     *
     * @see \Codeception\Module\Foundry::haveMultiple()
     */
     ...
     *
     * @see \Codeception\Module\Foundry::make()
     */
     ...
     * @return object[]
     *
     * @see \Codeception\Module\Foundry::makeMultiple()
     */
     ...
     *
     * @see \App\Tests\Helper\Functional::grabNumRecords()
     */
     ...
     * ```
     *
     * @see \App\Tests\Helper\Functional::grabRepository()
     */
     ...
     * @param array  $criteria    Optional query criteria
     *
     * @see \App\Tests\Helper\Functional::seeNumRecords()
     */
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * @see \App\Tests\Helper\Functional::findFirstEntityId()
     */
    public function findFirstEntityId()
    {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('findFirstEntityId', func_get_args()));
    }

    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * @see \App\Tests\Helper\Functional::amOnAdminIndexPageFor()
     */
    public function amOnAdminIndexPageFor(string $dashboard, string $controller, ?string $query = null)
    {
        return $this->getScenario()->runStep(new \Codeception\Step\Condition('amOnAdminIndexPageFor', func_get_args()));
    }

    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * @see \App\Tests\Helper\Functional::amOnAdminNewFormPageFor()
     */
    public function amOnAdminNewFormPageFor(string $dashboard, string $controller)
    {
        return $this->getScenario()->runStep(new \Codeception\Step\Condition('amOnAdminNewFormPageFor', func_get_args()));
    }

    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * @see \App\Tests\Helper\Functional::amOnAdminEditFormPageFor()
     */
    public function amOnAdminEditFormPageFor(string $dashboard, string $controller, ?string $query = null)
    {
        return $this->getScenario()->runStep(new \Codeception\Step\Condition('amOnAdminEditFormPageFor', func_get_args()));
    }

    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * @see \App\Tests\Helper\Functional::amOnAdminDetailPageFor()
     */
    public function amOnAdminDetailPageFor(string $dashboard, string $controller, ?string $query = null)
    {
        return $this->getScenario()->runStep(new \Codeception\Step\Condition('amOnAdminDetailPageFor', func_get_args()));
    }

    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * @see \App\Tests\Helper\Functional::amOnAdminFilterRenderPageFor()
     */
    public function amOnAdminFilterRenderPageFor(string $dashboard, string $controller)
    {
        return $this->getScenario()->runStep(new \Codeception\Step\Condition('amOnAdminFilterRenderPageFor', func_get_args()));
    }

    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * @see \App\Tests\Helper\Functional::receiveFileResponse()
     */
    public function receiveFileResponse(string $actionSelector)
    {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('receiveFileResponse', func_get_args()));
    }

    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * @see \App\Tests\Helper\Functional::getSpreedSheetTabCount()
     */
    public function getSpreedSheetTabCount(string $filename): int
    {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getSpreedSheetTabCount', func_get_args()));
    }

    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * @see \App\Tests\Helper\Functional::deleteExportFile()
     */
    public function deleteExportFile(string $filename)
    {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('deleteExportFile', func_get_args()));
    }
}
