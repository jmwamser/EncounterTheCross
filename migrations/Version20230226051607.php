 ...
 */
final class Version20230226051607 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event_attendee (id INT UNSIGNED AUTO_INCREMENT NOT NULL, launch_point_id INT UNSIGNED NOT NULL, church VARCHAR(255) DEFAULT NULL, invited_by VARCHAR(255) DEFAULT NULL, questions_or_comments LONGTEXT DEFAULT NULL, concerns LONGTEXT DEFAULT NULL, row_pointer BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', UNIQUE INDEX UNIQ_57BC3CB75A89FD83 (row_pointer), INDEX IDX_57BC3CB7A495DAEF (launch_point_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE event_server (id INT UNSIGNED AUTO_INCREMENT NOT NULL, row_pointer BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', UNIQUE INDEX UNIQ_68F4A2A45A89FD83 (row_pointer), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
